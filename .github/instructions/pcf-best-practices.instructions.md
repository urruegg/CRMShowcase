...
> Imported from
> [`github/awesome-copilot@ab7544d`](https://github.com/github/awesome-copilot/blob/ab7544d03d4c49fdd07f5958e1888ad39c4118e2/instructions/pcf-best-practices.instructions.md).
> CRMShowcase override: use synthetic data only, keep customer-impacting
> actions human-approved, localize user-visible metadata and resources for
> EN/DE/FR/IT, and account for Dataverse service-protection limits in every
> `context.webAPI` design.
