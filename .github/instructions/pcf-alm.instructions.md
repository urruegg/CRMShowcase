...
> Imported from
> [`github/awesome-copilot@ab7544d`](https://github.com/github/awesome-copilot/blob/ab7544d03d4c49fdd07f5958e1888ad39c4118e2/instructions/pcf-alm.instructions.md).
> CRMShowcase override: PCF source and unpacked solution metadata live under
> `solution/`; DEV is unmanaged, while TEST and later environments receive
> managed solutions through explicit update/stage/apply-upgrade modes. Use
> Entra workload identity, never client secrets, and preserve EN/DE/FR/IT
> metadata plus story/ADR/test/evidence traceability.
