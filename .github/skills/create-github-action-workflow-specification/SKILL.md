...
description: 'Use when documenting, explaining, reviewing, or creating a maintainable behavioral specification for an existing GitHub Actions workflow.'
---

# Create GitHub Actions Workflow Specification

> Imported from
> [`github/awesome-copilot@ab7544d`](https://github.com/github/awesome-copilot/blob/ab7544d03d4c49fdd07f5958e1888ad39c4118e2/skills/create-github-action-workflow-specification/SKILL.md).
> CRMShowcase workflow specifications belong under `docs/ci/`, link their
> `US-###` and relevant ADRs, and document OIDC identity, GitHub Environment,
> Dataverse solution mode, rollback, and evidence requirements.
