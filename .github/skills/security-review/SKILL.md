...
description: 'Use when scanning code or dependencies for exploitable vulnerabilities, secrets, injection, insecure authentication or authorization, unsafe cryptography, data exposure, or security-sensitive business-logic flaws.'
---

# Security Review

> Imported from
> [`github/awesome-copilot@ab7544d`](https://github.com/github/awesome-copilot/blob/ab7544d03d4c49fdd07f5958e1888ad39c4118e2/skills/security-review/SKILL.md).
> Findings involving secrets, real customer data, or customer-production
> connectivity are critical CRMShowcase guardrail violations. Patches remain
> proposals until reviewed; never auto-apply them.
