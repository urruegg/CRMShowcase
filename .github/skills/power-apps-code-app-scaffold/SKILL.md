...
description: 'Use when creating or restructuring a Power Apps Code App with React, TypeScript, Vite, PAC CLI, Power Apps SDK, connectors, local development, testing, or deployment.'
---
...
- Install and configure the Power Apps SDK (`@microsoft/power-apps ^1.0.3`)
