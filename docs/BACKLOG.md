...
## Epic 6 — Contoso Insurance prototype intake and data-model baseline (Sprint 2)

Traces to
[`docs/superpowers/specs/2026-08-08-contoso-insurance-prototype-intake-design.md`](./superpowers/specs/2026-08-08-contoso-insurance-prototype-intake-design.md).

| ID | Story | Status |
| --- | --- | --- |
| US-601 | Export and unpack the Contoso Insurance prototype into a quarantined intake area | Done — [#6](https://github.com/urruegg/CRMShowcase/issues/6) |
